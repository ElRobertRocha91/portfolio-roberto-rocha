...
export default function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 w-full bg-[--background-header] backdrop-blur-lg z-10">
            <div className="flex items-center justify-between py-2 px-2 sm:px-6 lg:px-16">
                ...
                <nav className="flex items-center text-xl font-medium hidden lg:block">
                    <Link href="#home" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
                    ...
                    <Link href="#about" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
                    focus:text-[#00ffee] focus:underline focus:underline-offset-4 focus:decoration-2 active:underline active:text-[#00ffee;]">About</Link>
                    <Link href="#education" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
                    ...
                    <Link href="#services" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
                    ...
                    <Link href="#proyects" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
                    ...
                    <Link href="#contact" className="mx-4 hover:text-[#00ffee] hover:underline hover:underline-offset-4 hover:decoration-2 
